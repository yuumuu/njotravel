...
<head>
    ...
    <title>Profile - Dashboard | Njotravel</title>
</head>
            ...
            <div class="d-flex flex-column justify-content-start align-items-start w-100 position-relative overflow-y-auto sidebar">
                ...
                <div class="nav-side text-white w-100 pb-2">
                    ...
                    <div onclick="dropdownActive(this)" class="nav-link position-relative fs-5 py-2 bg-orange ps-3 fw-bold text-dark dropdown dropdown-active">
                        ...
                        <?php else : ?>
                        <?php endif; ?>
                        <a href="user_profile.php" class="nav-link fw-semibold"><li class="lh-1 py-2 fs-6">Profile</li></a>
                    </div>
                    <?php if($role_login == "Admin") : ?>
            ...
            <div class="weltext position-absolute top-0 d-flex justify-content-between align-items-start px-5 py-3 pb-5 w-100 bg-orange">
                <h4 class="text-dark ms-3">
                    ...
                    <span class="fs-6 fw-semibold bg-white rounded-3 px-5">
                        <span class="ms-1 bg-danger bg-gradient py-0 px-2 rounded-5 fs-6 text-center fw-normal text-white">My</span>
                        Profile
                    </span>
                </h4>
                ...
                <div class="w-100 vh-auto row px-5 py-2 my-2">
                    <div class="bg-white col p-4 mx-2 rounded-4 shadow w-100">
                        <div class="d-flex justify-content-between align-items-start w-100">
                            <div>
                                <h3 class="text-dark fw-bold lh-1">My Profile</h3>
                            </div>
                            <div>
                                <a href="<?= $url; ?>" class="btn btn-danger bg-gradient shadow p-1 px-3 rounded-5">Back</a>
                                <a href="edit_user.php?id=<?= $result_login['id']; ?>" class="btn btn-dark bg-gradient shadow p-1 px-3 rounded-5">Edit</a>
                            </div>
                        </div>
                        <div class="row w-100 align-items-center">
                            <div class="col-4 d-flex flex-column justify-content-start align-items-center pt-4">
                                <div class="img-profile bg-dark rounded-4 border-0" 
                                style="background-image:url('./assets/library_image/<?= $result_login['photoProfileName'] ?>')"
                                ></div>
                                <p class="lh-1 fw-light mt-4 text-center"><?= $result_login['photoProfileName'] ?></p>
                            </div>
                            <ul class="col-8 d-block">
                                <hr class="mt-0">
                                <li class="p-1 lh-1">
                                    <p class="fs-6 fw-light text-dark">
                                        <span class="fw-semibold">Nama Lengkap : </span>
                                        <?= ucwords($result_login['firstName'] . " " . $result_login['lastName']); ?>
                                    </p>
                                </li>
                                <li class="p-1 lh-1">
                                    <p class="fs-6 fw-light text-dark">
