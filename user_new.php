...
<head>
    ...
    <title>New Users - Dashboard | Njotravel</title>
</head>
            ...
            <div class="d-flex flex-column justify-content-start align-items-start w-100 position-relative overflow-y-auto sidebar">
                ...
                <div class="nav-side text-white w-100 pb-2">
                    ...
                    <div onclick="dropdownActive(this)" class="nav-link position-relative fs-5 py-2 bg-orange ps-3 fw-bold text-dark dropdown dropdown-active">
                        ...
                        <a href="user_new.php" class="nav-link fw-semibold"><li class="lh-1 py-2 fs-6">Add New</li></a>
                ...
                <div class="w-100 vh-auto row px-5 py-2 my-2">
                    <div class="bg-white col p-4 mx-2 rounded-4 shadow w-100">
                        <div class="d-flex justify-content-between align-items-start w-100">
                            <div>
                                <h3 class="text-dark fw-bold lh-1">Add Users</h3>
                                <h6 class="text-dark fw-light lh-1 mb-4">Input some data below for create new user account</h6>
                            </div>
                            <a href="user_all.php" class="btn btn-danger bg-gradient shadow p-1 px-3 rounded-5">Back</a>
                        </div>
                        <form action="add_user_process.php" method="post" enctype="multipart/form-data" class="row">
                            <li class="col-6 p-2">
                                <label class="fw-light" for="firstName"><small>First Name</small></label>
                                <input type="text" name="firstName" id="firstName" class="form-control rounded-3" autocomplete="off" required>
                            </li>
                            <li class="col-6 p-2">
                                <label class="fw-light" for="lastName"><small>Last Name</small></label>
                                <input type="text" name="lastName" id="lastName"  class="form-control rounded-3" autocomplete="off" required>
                            </li>
                            <li class="col-6 p-2">
                                <label class="fw-light" for="username"><small>Username</small></label>
                                <input type="text" name="username" id="username" class="form-control rounded-3" autocomplete="off" required>
                            </li>
                            <li class="col-6 p-2">
                                <label class="fw-light" for="email"><small>Email</small></label>
                                <input type="email" name="email" id="email" class="form-control rounded-3" autocomplete="off" required>
                            </li>
                            <li class="col-6 p-2">
                                <label class="fw-light" for="password"><small>Password</small></label>
                                <input type="password" name="password" id="password" class="form-control rounded-3" autocomplete="off" required>
                            </li>
                            <li class="col-6 p-2">
                                <label class="fw-light" for="photoProfile"><small>Photo Profile</small></label>
                                <input type="file" name="photoProfile" id="photoProfile" class="form-control rounded-3" autocomplete="off" required>
                            </li>
                            <li class="col p-2">
