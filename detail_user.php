                ...
                <div class="w-100 vh-auto row px-5 py-2 my-2">
                    <div class="bg-white col p-4 mx-2 rounded-4 shadow w-100">
                        <div class="d-flex justify-content-between align-items-start w-100">
                            <div>
                                <h3 class="text-dark fw-bold lh-1">Detail Data User</h3>
                            </div>
                            <div>
                                <input type="hidden" value="<?= $data['id'] ?>" name="id" id="id">
                                <a href="<?= $url; ?>" class="btn btn-danger bg-gradient shadow p-1 px-3 rounded-5">Back</a>
                                <?php if($role_login == "Admin") : ?>
                                <a href="edit_user.php?id=<?= $data['id'] ?>" class="btn btn-dark bg-gradient shadow p-1 px-3 rounded-5">Edit</a>
                                <?php else : ?>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="row w-100 align-items-center">
                            <div class="col-4 d-flex flex-column justify-content-start align-items-center pt-4">
                                <div class="img-profile detail-user bg-dark rounded-4 border-0" 
                                style="background-image:url('assets/library_image/<?= $data['photoProfileName'] ?>');"
                                ></div>
                                <p class="lh-1 fw-light mt-4 text-center"><?= $data['photoProfileName'] ?></p>
                            </div>
