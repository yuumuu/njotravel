...
if(isset($_POST['submitSettings'])) {
    $titleAbout = strtolower($_POST['titleFeatureAbout']);
    ...
    if(isset($_FILES['featureImage']) && isset($_FILES['bannerImage'])) {
        if($featureImage_size < 5000000 && $bannerImage_size < 5000000) {
                ...
                $query = "INSERT INTO set_about VALUES (NULL, '$titleAbout', '$featureName_new', '$featureDesc', '$bannerName_new', '$bannerDesc', NOW());";
