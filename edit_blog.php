            ...
            <div class="position-absolute z-2 w-100 main">
                <div class="w-100 vh-auto row px-5 py-2 my-2">
                    <div class="bg-white col-12 p-2 mx-2 rounded-4 row justify-content-center shadow mb-4 text-center">
                        ...
                        <a href="edit_blog.php" class="col-1 column-center btn btn-white mx-1 hov-set" style="opacity: .5; scale: 1.15;">
                    ...
                    </div><form method="POST" action="set_blog_process.php" enctype="multipart/form-data" class="bg-white col-12 p-4 mx-2 rounded-4 row shadow mb-4">
                        <div class="w-100">
                        ...
                        <div class="col-12 px-2 my-2">
                            <label class="fw-light" for="titleFeatureBlog"><small>Title</small></label>
                            <input type="text" name="titleFeatureBlog" id="titleFeatureBlog" class="form-control" value="<?= $result_blog['title'] ?>" required>
                        </div>
