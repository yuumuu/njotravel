            ...
            <div class="d-flex flex-column justify-content-start align-items-start w-100 position-relative overflow-y-auto sidebar">
                ...
                <div class="nav-side text-white w-100 pb-2">
                    ...
                    <div onclick="dropdownActive(this)" class="nav-link position-relative fs-5 py-2 bg-orange ps-3 fw-bold text-dark dropdown dropdown-active">
                        ...
                        <a href="media_new.php" class="nav-link fw-semibold"><li class="lh-1 py-2 fs-6">Add New</li></a>
                    </div>
                    <div onclick="dropdownActive(this)" class="nav-link position-relative fs-5 py-2 ps-3 fw-normal text-light dropdown">
            ...
            <div class="weltext position-absolute top-0 d-flex justify-content-between align-items-start px-5 py-3 pb-5 w-100 bg-orange">
                <h4 class="text-dark ms-3">
                    ...
                    <span class="fs-6 fw-semibold bg-white rounded-3 px-5">
                        <span class="me-1 bg-danger bg-gradient py-0 px-2 rounded-5 fs-6 text-center fw-normal text-white">Add</span>
                        Media
                    </span>
                </h4>
            ...
            <div class="position-absolute z-2 w-100 main">
                <div class="w-100 vh-auto row px-5 py-2 my-2">
                    <div class="bg-white col-12 p-4 mx-2 rounded-4 row shadow mb-5">
                        <div class="w-100">
                            <h3 class="text-dark fw-bold m-0">Add Media</h3>
                            <p class="fs-6 m-0 p-0 text-secondary">Select from your Computer</p>
                        </div>
                        <div class="w-100 mt-4 border d-flex flex-column justify-content-center align-items-center p-5">
                            <span class="text-secondary">Import your pictures from here</span>
                            <form action="add_media_process.php" enctype="multipart/form-data" method="post" class="mt-3 d-flex flex-column justify-content-center align-items-center">
                                <input type="file" name="fileName" id="fileName" class="btn btn-dark p-0" onchange="readURL(event)" accept="image/*">
                                <input type="submit" value="Upload" name="submit_media" class="mt-3 btn btn-danger rounded-5 bg-gradient px-5 py-2 shadow border-0">
                            </form>
                            <p class="fs-6 m-0 mt-3 p-0 text-secondary" id="name_output"></p>
                            <img id="output" class="w-50 shadow mt-2">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        var readURL = function(event) {
            ...
            reader.onload = function() {
                ...
                var dataName = input.files[0].name;
                var name_output = document.getElementById("name_output");
                name_output.innerHTML = dataName;
            };
