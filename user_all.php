...
<head>
    ...
    <title>All Users - Dashboard | Njotravel</title>
</head>
            ...
            <div class="d-flex flex-column justify-content-start align-items-start w-100 position-relative overflow-y-auto sidebar">
                ...
                <div class="nav-side text-white w-100 pb-2">
                    ...
                    <div onclick="dropdownActive(this)" class="nav-link position-relative fs-5 py-2 bg-orange ps-3 fw-bold text-dark dropdown dropdown-active">
                        ...
                        <a href="user_all.php" class="nav-link fw-semibold"><li class="lh-1 py-2 fs-6">All Users</li></a>
                        <?php if($role_login == "Admin") : ?>
                ...
                <div class="w-100 vh-auto row px-5 py-2 my-2">
                    <div class="bg-white col p-4 mx-2 rounded-4 row shadow mb-5">
                        <div class="w-100 d-flex justify-content-between align-items-center">
                            ...
                            <?php if($role_login == "Admin") : ?>
                                <a href="user_new.php" class="btn btn-dark fw-semibold py-2 px-3 rounded-4">Add New &plus;</a>
                            <?php else : ?>
                            <?php endif; ?>
                            </div>
                        <div class="w-100 d-flex justify-content-start align-items-start">
                            <form method="GET" action="" class="mt-2 w-100">
                                <select name="filterRole" id="filterRole" class="btn btn-light shadow rounded-5 rounded-end-0 w-auto px-2 py-2 fw-semibold text-start">
                                    <option value="">All Role</option>
                                    <option value="Admin" <?= ($selectRole == "Admin" ? "selected" : "") ?>>Admin</option>
                                    <option value="Author" <?= ($selectRole == "Author" ? "selected" : "") ?>>Author</option>
                                </select>
                        ...
                        <table class="w-100 mt-3">
                            <thead class="w-100">
                                <tr class="w-100 row fs-5 text-center py-2 bg-white rounded-5">
                                    ...
                                    <th class="col-2 fw-semibold">Username</th>
                                    <th class="col-3 fw-semibold">Name</th>
                                    <th class="col-2 fw-semibold">Email</th>
                                    <th class="col-2 fw-semibold">Role</th>
                            ...
                            <tbody class="w-100">
                                <?php
                                    ...
                                    while($data = mysqli_fetch_assoc($hasil)) {
                                        ...
                                        $namaLengkap = ucwords($data['firstName'] . " " . $data['lastName']);
                                        $email = $data['email'];
                                        $role = $data['role'];
                                ?>
                                <tr class="w-100 row fs-6 text-center py-3">
                                    <td class="col-1 px-2 fw-normal"><?= $i++; ?></td>
                                    <td class="col-2 px-2 fw-normal"><?= $username; ?></td>
                                    <td class="col-3 px-2 fw-normal"><?= $namaLengkap; ?></td>
                                    <td class="col-2 px-2 fw-normal"><?= $email; ?></td>
                                    <td class="col-2 px-2 fw-normal"><?= $role; ?></td>
                                    <td class="col-2 px-2 fw-normal d-flex flex-row-reverse justify-content-center align-items-center">
                                        ...
                                        <form action="delete_user_process.php" method="POST">
                                            ...
                                            <button title="delete" type="submit" class="btn btn-danger py-1 rounded-5 shadow">
                                                &#10006;
                                            </button>
                                        </form>
                                        <?php else : ?>
                                        <?php endif; ?>
                                        <a title="info" href="detail_user.php?id=<?= $data['id'] ?>" class="btn btn-secondary py-1 px-3 rounded-5 shadow mx-1">
                                            &#8505;
                                        </a>
                                        <?php if($role_login == "Admin") : ?>
                                        <a title="edit" href="edit_user.php?id=<?= $data['id'] ?>" class="btn btn-dark py-1 px-2 rounded-5 shadow">
                                            &#9998;
                                        </a>
                                        <?php else : ?>
                                        <?php endif; ?>
