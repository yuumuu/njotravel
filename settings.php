            ...
            <div class="position-absolute z-2 w-100 main">
                <div class="w-100 vh-auto row px-5 py-2 my-2">
                    <div class="bg-white col-12 p-2 mx-2 rounded-4 row justify-content-center shadow mb-4 text-center">
                        <a href="settings.php" class="col-1 column-center btn btn-white mx-1 hov-set" style="opacity: .5; scale: 1.15;">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/d/dc/Settings-icon-symbol-vector.png" alt="" width="19" class="me-1">
                            <span>main</span>
                        </a>
                        <a href="edit_home.php" class="col-1 column-center btn btn-white mx-1 hov-set">
                    ...
                    <form method="POST" action="set_main_process.php" enctype="multipart/form-data" class="bg-white col-12 p-4 mx-2 rounded-4 row shadow mb-4">
                        <div class="w-100">
                        ...
                        <div class="col-6 px-2 my-2">
                            <label class="fw-light" for="companyName"><small>Company Name</small></label>
                            <input value="<?= $result_settings['company_name'] ?>" type="text" name="companyName" id="companyName" class="form-control" autocomplete="off" required>
                        </div>
                        <div class="col-6 px-2 my-2">
                            <label class="fw-light" for="companyLogo"><small>Company Logo</small></label>
                            <input value="./assets/image/<?= $result_settings['logo'] ?>" type="file" name="companyLogo" id="companyLogo" class="form-control" autocomplete="off" accept="image/*" required>
                        </div>
                        <div class="col-6 px-2 my-2">
                            <label class="fw-light" for="telephonePT"><small>Company Telp</small></label>
                            <input value="<?= $result_settings['whatsapp_number'] ?>" type="text" name="telephonePT" id="telephonePT" class="form-control" autocomplete="off" required>
                        </div>
                        <div class="col-6 px-2 my-2">
                            <label class="fw-light" for="facebook"><small>Facebook</small></label>
                            <input value="<?= $result_settings['facebook_url'] ?>" type="url" name="facebook" id="facebook" class="form-control" autocomplete="off" required>
                        </div>
                        <div class="col-6 px-2 my-2">
                            <label class="fw-light" for="instagram"><small>Instagram</small></label>
                            <input value="<?= $result_settings['instagram_url'] ?>" type="url" name="instagram" id="instagram" class="form-control" autocomplete="off" required>
                        </div>
                        <div class="col-6 px-2 my-2">
                            <label class="fw-light" for="youtube"><small>Youtube</small></label>
                            <input value="<?= $result_settings['youtube_url'] ?>" type="url" name="youtube" id="youtube" class="form-control" autocomplete="off" required>
                        </div>
                        <div class="col-12 px-2 my-2">
                            <label class="fw-light" for="companyDesc"><small>company Description</small></label>
                            <textarea name="companyDesc" id="companyDesc" cols="30" rows="3" class="form-control"><?= $result_settings['description'] ?></textarea>
                        </div>
                        <div class="col-12 px-2 text-center my-2">
                            <input type="submit" name="submitSettings" id="submitSettings" class="btn btn-dark bg-gradient p-2 px-5 rounded-5 shadow" value="Submit">
                        </div>
                    </form>

                    <form action="set_sponsor_process.php" method="post" class="bg-white col-12 p-4 mx-2 rounded-4 rounded-bottom-0 row shadow" enctype="multipart/form-data">
                        <div class="w-100">
                            <h3 class="text-dark fw-bold lh-1">
                                Our Partners
                                <!-- 
                        ...
                        <div class="col-6 px-2 my-2">
                            <label class="fw-light" for="sponsorName"><small>Sponsor Name</small></label>
                            <input type="text" name="sponsorName" id="sponsorName" class="form-control" autocomplete="off" required>
                        </div>
                        <div class="col-6 px-2 my-2">
                            <label class="fw-light" for="sponsorFile"><small>Sponsor Photo</small></label>
                            <input type="file" name="sponsorFile" id="sponsorFile" class="form-control" autocomplete="off" accept="image/*" required>
                        </div>
                        <div class="col-6 px-2 my-2">
                            <label class="fw-light" for="sponsorURL"><small>Sponsor URL</small></label>
                            <input type="url" name="sponsorURL" id="sponsorURL" class="form-control" autocomplete="off" required>
                        </div>
                        <div class="col-6 px-2 my-2">
                            <p class="fw-light m-0"><small> Note : </small></p>
                            <p class="m-0 fs-7 w-75">
                                This form for manage company partners, company sponsorships, and company clients.
                            </p>
                        </div>
                        <div class="col-12 px-2 text-center">
                            <input type="submit" name="submitPartners" id="submitPartners" class="btn btn-dark bg-gradient p-2 px-5 rounded-5 shadow" value="Submit">
                        </div>
                    </form>
                    
                    <table class="bg-white col-12 p-4 mx-2 rounded-4 rounded-top-0 row shadow mb-4">
                        <thead class="w-100 mb-3">
                            <tr class="w-100 row m-0 rounded-5 bg-white shadow py-2 text-center">
                        ...
                        <tbody class="w-100">
                            <?php
                                ...
                                $i = 1;
                                while($result_sponsor = mysqli_fetch_assoc($query_sponsor)) {

                            ?>
                            <tr class="w-100 row m-0 py-2 text-center">
                                <td class="col-1"><?= $i++ ?></td>
                                <td class="col-3 text-capitalize">
                                    <?= $result_sponsor['sponsor_name'] ?>
                                </td>
                                <td class="col-3">
                                    <div class="w-100"
                                    style="height: 8rem!important;
                                    background-image: url('./assets/sponsor/<?= $result_sponsor['sponsor_logo'] ?>');
                                ...
                                <td class="col-3">
                                    <a href="<?= $result_sponsor['sponsor_url'] ?>" target="_blank">
                                        <?= $result_sponsor['sponsor_url'] ?>
                                    </a>
                                </td>
                                <td class="col-2 px-2 fw-normal row-center-start">
                                    <form action="delete_sponsor_process.php" method="POST">
                                        <input type="hidden" value="<?= $result_sponsor['id'] ?>" name="id" id="id">
                                        <input type="submit" name="submitSponsor" value="&#10006;" class="btn btn-danger rounded-circle shadow-sm text-white btn-media m-1">
                                    </form>
                                </td>
                            </tr>
                            <?php }; ?>
