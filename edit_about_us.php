            ...
            <div class="position-absolute z-2 w-100 main">
                <div class="w-100 vh-auto row px-5 py-2 my-2">
                    <div class="bg-white col-12 p-2 mx-2 rounded-4 row justify-content-center shadow mb-4 text-center">
                        ...
                        <a href="edit_about_us.php" class="col-1 column-center btn btn-white mx-1 hov-set" style="opacity: .5; scale: 1.15;">
                    ...
                    <form method="POST" action="set_about_process.php" enctype="multipart/form-data" class="bg-white col-12 p-4 mx-2 rounded-4 row shadow mb-4">
                        <div class="w-100">
                        ...
                        <div class="col-6">
                            <div class="w-100 px-2 my-2">
                                <label class="fw-light" for="titleFeatureAbout"><small>Title</small></label>
                                <input type="text" name="titleFeatureAbout" id="titleFeatureAbout" class="form-control" value="<?= $result_about['title'] ?>">
                            </div>
                            <div class="w-100 px-2 my-2">
                                <label class="fw-light" for="featureImage"><small>Feature Image</small></label>
                                <input type="file" name="featureImage" id="featureImage" class="form-control" accept="image/*">
                            </div>
                            <div class="w-100 px-2 my-2">
                                <label class="fw-light" for="bannerImage"><small>Banner Image</small></label>
                                <input type="file" name="bannerImage" id="bannerImage" class="form-control" accept="image/*">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="w-100 px-2 my-2">
                                <label class="fw-light" for="descMain"><small>Main Description</small></label>
                                <textarea name="descMain" id="descMain" cols="30" rows="8" class="form-control"><?= $result_about['featureDesc'] ?></textarea>
                            </div>
                            <div class="w-100 px-2 my-2">
                                <label class="fw-light" for="bannerDesc"><small>Banner Description</small></label>
                                <textarea name="bannerDesc" id="bannerDesc" cols="30" rows="8" class="form-control"><?= $result_about['bannerDesc'] ?></textarea>
                            </div>
                        </div>
                    ...
                    <form class="bg-white col-12 p-4 mx-2 rounded-4 row shadow mb-4" method="POST" action="set_qna_process.php">
                        <h3 class="fw-bold text-center m-0">Create QnA</h3>
                        <div class="col-12 px-4 my-2">
                            <label class="fw-light" for="question"><small>Question</small></label>
                            <input type="text" name="question" id="question" class="form-control mb-2" required>
                            <label class="fw-light" for="answer"><small>Answer</small></label>
                            <textarea name="answer" id="answer" cols="30" rows="2" class="form-control" required></textarea>
                        </div>
                        <div class="col-12 px-2 text-center my-2">
                            <input type="submit" name="submitSettings" id="submitSettings" class="btn btn-dark bg-gradient p-2 px-5 rounded-5" value="Submit">
                        </div>
                    ...
                    <div class="bg-white col-12 p-4 mx-2 rounded-4 row shadow mb-4">
                        <h3 class="fw-bold text-center m-0">Question Lists</h3>
                        <div class="main-question mt-2">
                            <?php
                            $query_qna = "SELECT * FROM set_qna";
                            $result_qna = mysqli_query($conn, $query_qna);
                            while($data_qna = mysqli_fetch_assoc($result_qna)) {
                            ?>
                            <div class="content-question w-100" data-aos="fade-up" data-aos-duration="800">
                                <div class="question d-flex justify-content-between">
                                    <div>
                                        <span><?= $data_qna['question'] ?></span>
                                        <span class="fw-light fs-7">By </span><span class="fw-bold fs-7"><?= $data_qna['author'] ?></span>
                                    </div>
                                    <img src="./assets/svg/dropdown.svg" width="30" draggable="false" class="shadow rounded-circle">
                                    <a href="delete_qna_process.php?id=<?= $data_qna['id'] ?>" class="btn btn-danger rounded-circle shadow" style="scale: 0.9;">✖</a>
                                </div>
...
<!-- title, feature image, desc, bg banner, question -->
