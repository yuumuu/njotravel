...
<head>
    ...
    <title>New Pages - Dashboard | Njotravel</title>
</head>
            ...
            <div class="d-flex flex-column justify-content-start align-items-start w-100 position-relative overflow-y-auto sidebar">
                ...
                <div class="nav-side text-white w-100 pb-2">
                    ...
                    <div onclick="dropdownActive(this)" class="nav-link position-relative fs-5 py-2 bg-orange ps-3 fw-bold text-dark dropdown dropdown-active">
                        ...
                        <a href="page_new.php" class="nav-link fw-semibold"><li class="lh-1 py-2 fs-6">Add New</li></a>
                    </div>
                    <div onclick="dropdownActive(this)" class="nav-link position-relative fs-5 py-2 ps-3 fw-normal text-light dropdown">
        ...
        <div class="col-10 vh-100 position-relative bg-light overflow-y-auto z-1 d-flex flex-column justify-content-start align-items-start p-0">
            ...
            <div class="position-absolute z-2 w-100 main">
                <div class="w-100 vh-auto row px-5 py-2 my-2">
                    <form method="POST" action="add_page_process.php" enctype="multipart/form-data" class="bg-white col p-4 mx-2 rounded-4 row shadow w-100">
                        <li class="col-8 p-2">
                            <input type="text" name="titlePage" id="titlePage" placeholder="Add Title" class="form-control shadow-sm fs-4 fw-normal p-2 px-3 mb-3" autocomplete="off" required>
                            <textarea name="editorPage" id="editorPage" class="shadow-sm" required></textarea>
                        </li>
                        <li class="col-4 p-2">
                            <ul class="w-100 py-2 px-3 my-3 shadow-sm rounded-2 border">
                                Featured Image
                                <input type="file" name="featureImage" id="featureImage" class="btn border btn-light w-100 py-2" accept="image/*" required>
                            </ul>
                            <ul class="w-100 py-2 px-3 my-3 shadow-sm rounded-2 border">
                                Image Banner
                                <input type="file" name="bannerImage" id="bannerImage" class="btn border btn-light w-100 py-2 mb-2" accept="image/*">
                                Description Banner
                                <textarea name="bannerDesc" id="bannerDesc" class="form-control w-100"
                                style="min-height: 10.5rem;"
                                ></textarea>
                            </ul>
                            <input type="submit" onclick="tinyMCE.triggerSave(true, true);" name="publishPage" value="Publish" class="btn btn-dark bg-gradient border-0 p-2 fw-semibold px-5 rounded-3 shadow-sm">
                        </li>
                    </form>
                </div>
            </div>
